  ...
  <div>
    ...
    <div class="box1" v-if="ishow" @click.self="ishow=false">
      <div class="box2">
        ...
        <div class="dibu">
          <span class="mshu">报名人数</span>
          <el-input v-model="user.num" class="miaoshu" placeholder="描述"></el-input>
        </div>
    ...
    btn() {
      this.$axios({
        ...
        params: {
          img: `http://img3.imgtn.bdimg.com/it/u=3414414030,1436910499&fm=11&gp=0.jpg`,
          num: this.user.num,
          teacherImg: `http://img3.imgtn.bdimg.com/it/u=3414414030,1436910499&fm=11&gp=0.jpg`
        }
      }).then(res => {
        if (res.data.isok) {
          alert(res.data.info);
